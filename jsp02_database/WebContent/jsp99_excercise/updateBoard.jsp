	...
	<div class="container" align="center">
		...
		<form action="updateBoard.jsp" method="post">
			<table class="table table-bordered table-white table-hover">
				<tr>
					<td width="20%">글번호</td>
					<td><input type="text" name="bno" class="form-control" size="30" value="<%= bno %>" /></td>
				</tr>
				<tr>
					<td width="20%">제목</td>
				...
				<tr>
					<td width="20%">내용</td>
					<td>
						<input type="text" name="content" class="form-control" size="30" value="<%= content %>" >
					</td>
				</tr>
			</table>
			<input type="hidden" name="id" value="<%= bno %>" />
			<input type="submit" class="btn btn-primary mt-sm-2" value="게시글 수정하기" />
