...
<!-- 
	...
	A. EL의 구성
	   ...
	   "# {}"형식의 구분을 지원하고 있는데 차이점은 EL의 값을 언제 생성하는냐에 차이가 있다.
	...
	C. EL의 기본객체
	   ...
	   2. pageScore 	   : pageContext객체에 저장된 속성으로 Map<속성, 값>형태의 객체
	  ...
	  11. initPrame 	   : 초기화파라미터 <이름, 값>의 Map객체, application.getInitParameter()메서드와 동일
	...
	E. EL의 연산자
	   ...
	   6. 세미콜론   : (;)
		  ...
		  $ {1+1; 10+10}의 결과는 20 만 출력, 즉, $ {A; B}의 결과는 최종의 결과인 B만 출력
		  $ {var = 10}의 결과는 10이 출력
 -->
<%
