...
<!-- 
	...
	2. 태그파일에서 사용가능한 디렉티브
	   ...
	   b. taglb 	: tag파일에서 사용할 tag library를 정의
	...
	3. 태그디렉티브의 속성
	   ...
	   i. trimDiretiveWhiteSpace 	   : page디렉티브의 속성과 동일, 공백문자를 제거여무
	...
	4. 태그파일에서 사용가능한 기본(내장)객체
	   ...
	   d. session 	  : jsp페이지의 session과 동일
	   e. application : jsp페이지의 application과 동일
	   f. out 		  : jsp페이지의 out과 동일
