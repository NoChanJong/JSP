...
<body>
	...
	gropingUsed : <fmt:formatNumber value="${ price }" type="currency" currencySymbol="$" groupingUsed="false"/> <br />
	...
	both-full: <fmt:formatDate value="${ now }" type="date" dateStyle="full" timeStyle="full"/> <br />
	pattern  : <fmt:formatDate value="${ now }" type="time" pattern="hh:mm"/>
	<hr />
