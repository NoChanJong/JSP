...
<!--  
	...
	3. out(javax.servlet.jsp.JspWriter) : jsp페이지의 생성결과를 출력할 떄 사용하는 출력문자스트림
...
<!-- 
	...
	2) out객체의 buffer관련메서드
	   ...
	   c. clear() 		  : 버퍼전체를 비움, 이미 flush가 되어있다면 exception발생
	   d. clearBuffer()   : 버퍼전체를 비움, 이미 flush가 되어있다면 exception발생하지 않음
	   e. flush() 		  : 버퍼를 flush처리
