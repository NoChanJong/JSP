...
/*
	...
	요청을 제어할 수 있도록한다. 또한, 웹서버와 응답처리 사이에 위치하여 응답을 제어할 수 있다.
	
	즉, 필터는 웹브라우저의 요청을 필터의 체인으로 연결해서 다음단계로 보낼 수도 있고 다른 형태의 결과를
	웹브라우저에 전송할 수도 있다. 
...
public class NullParameterFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		NullParameterReqWrapper reqWrapper = new NullParameterReqWrapper((HttpServletRequest) req);
